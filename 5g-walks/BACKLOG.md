Backlog for MapQuest enhancements
...
- ✅ Save routes to localStorage from Create Route and Featured Routes pages.
- ✅ Display saved routes on My Routes page with view/delete functionality.
